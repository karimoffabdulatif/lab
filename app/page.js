...
export default function Home() {
  return (
    <main className="container">
      <section className="text-center">
        <div className="justify-center pl-[320px] pb-12  items-center">
          <h1 className="text-5xl font-semibold w-[700px] pt-[80px] text-blue-950">
            Inspire Students with Immersive Learning
          </h1>

          <p className="text-xl w-[700px] pt-[40px] text-gray-600">
  ...
  transform transition duration-300 ease-in-out hover:scale-105 hover:bg-blue-800">
      ...
      <div className="w-full  bg-blue-200 rounded-3xl shadow-xl p-8 space-y-6">
        {/* Birinchi bo'lak */}
